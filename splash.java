...
class splash{
    public static void main(String s[]){ //this is the main class of my project
...
class sframe extends JFrame implements Runnable{
    ...
    sframe(String s){
        super(s);
        setLayout(new FlowLayout()); //there are different types of layout in java
        ImageIcon c1 = new ImageIcon(ClassLoader.getSystemResource("icon/payroll_system.jpg"));
        Image i1 = c1.getImage().getScaledInstance(730, 550,Image.SCALE_DEFAULT); //it is for change image dimension
